  ...
  return (
    <main className="min-h-screen bg-[#0a0c0b] text-[#f4efe6]">
      ...
      <section className="grid min-h-[100svh] place-items-center bg-[radial-gradient(circle_at_center,#272117_0%,#0a0c0b_65%)] px-6 text-center">
        <div>
          <p className="font-mono text-[9px] uppercase tracking-[.3em] text-[#d4af37]">
            Decide Smart. Live Better.
          </p>
          <h1 className="mt-5 font-display text-6xl tracking-[-.05em] md:text-9xl">
            ENTER
            <br />
            YOUR HOME
          </h1>
          <p className="mx-auto mt-6 max-w-md font-body text-sm text-white/55">
            Loading the cinematic home journey…
          </p>
        </div>
      </section>
    </main>
