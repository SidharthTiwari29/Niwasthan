    ...
    <div className="space-y-10">
      ...
      <section className="relative overflow-hidden rounded-[1.75rem] bg-ink px-6 py-8 text-paper shadow-xl shadow-ink/10 md:px-10 md:py-10">
        ...
        <div className="relative max-w-4xl">
          ...
          <div className="mt-8 flex flex-wrap gap-3"><Link href={`/properties/${propertyId}/floor-plan`} className="inline-flex items-center gap-2 rounded-full bg-brass px-5 py-3 font-body text-sm font-semibold text-ink">{t("uploadFloorPlan")} ↗</Link><Link href={`/properties/${propertyId}/floor-plan/review`} className="inline-flex items-center gap-2 rounded-full border border-paper/20 px-5 py-3 font-body text-sm text-paper/80 transition-colors hover:border-brass">{t("reviewDetectedRooms")} →</Link></div>
        </div>
      </section>
