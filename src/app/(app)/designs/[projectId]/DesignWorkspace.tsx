...
// Real, deliberately kept from the render-pipeline bug fix: a render's
// actual result lives at the provider's own externalUrl, included
// directly in the poll response - not fetched through this app's
// internal-storage download-url route, which only works for objects
// this app's own storage actually holds.
type RenderJobAsset = {
  id: string;
  type: string;
  contentType: string;
